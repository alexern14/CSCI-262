...
public:
	...
	virtual void initialize(string text, int order) = 0;

	// produce a text in the style of the example
	virtual string generate(int size) = 0;

	map<string, vector<char>> _map_model;
	map<vector<string>, vector<string>> _word_model;
};
